...
class Salaires {
    public static void main(String[] args) {
        ...
        p.ajouterEmploye(new Vendeur("95A001","Tato", "Jean", 55, "1995", 10000));
        p.ajouterEmploye(new Representant("01A023","PATCHA", "ADOUM", 28, "2001", 20000));
        p.ajouterEmploye(new Technicien("98A032","DR", "SANDA", 28, "1998", 1000));
        p.ajouterEmploye(new Manutentionnaire("98A033","ADAM", "FATIMA", 33, "1998", 45));
        p.ajouterEmploye(new TechnARisque("10A025","NASSAR", "YAYA", 48, "2010", 1000));
        p.ajouterEmploye(new ManutARisque("01A024","OUMAR", "DANMARK", 31, "2001", 45));
